...
import { validateCollectorDatabaseUrl } from "./connection.ts";
import { createCmrEdgeHandler } from "./runtime.ts";
...
async function openDatabase() {
  const connection = validateCollectorDatabaseUrl(
    environment("CMR_COLLECTOR_DATABASE_URL"),
...
const collectCmr = createCmrEdgeHandler({ openDatabase });
